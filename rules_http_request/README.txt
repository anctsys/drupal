...
See: https://www.drupal.org/project/rules_http_client and
https://www.drupal.org/docs/contributed-modules/rules-api-post
...
Look for a new Rules action "HTTP REQUEST" within the data section of Rules actions.
